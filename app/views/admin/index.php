        ...
        <div class="col-lg-4 col-sm-6 mb-4">
            ...
            <div class="portfolio-item">
                <a class="portfolio-link" data-bs-toggle="modal" href="<?php echo URLROOT ?>/admin/addCroisiere">
                    <div class="portfolio-hover" style="display: flex; justify-content: flex-end;">
                         <a href="<?php echo URLROOT ?>/admin/addCroisiere"><div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div></a>
                         <a href="<?php echo URLROOT ?>/admin/getCroisiere"><div class="portfolio-hover-content"><i class="fas fa-eye fa-3x"></i></div></a>
                    </div>
            ...
            <div class="portfolio-item">
                <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                    ...
                    <a href="<?php echo URLROOT ?>/admin/addNavire"><div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div></a>
                         <a href="<?php echo URLROOT ?>/admin/getNavire"><div class="portfolio-hover-content"><i class="fas fa-eye fa-3x"></i></div></a>
                ...
                <a class="portfolio-link" data-bs-toggle="modal" href="<?php echo URLROOT ?>/admin/addPort">
                    <div class="portfolio-hover" style="display: flex; justify-content: flex-end;">
                        <a href="<?php echo URLROOT ?>/admin/addPort"><div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div></a>
                         <a href="<?php echo URLROOT ?>/admin/getPort"><div class="portfolio-hover-content"><i class="fas fa-eye fa-3x"></i></div></a>
            ...
            <div class="portfolio-item">
                <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                    ...
                    <a href="<?php echo URLROOT ?>/admin/addChambre"><div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div></a>
                         <a href="<?php echo URLROOT ?>/admin/getChambre"><div class="portfolio-hover-content"><i class="fas fa-eye fa-3x"></i></div></a>
            ...
            <div class="portfolio-item" >
                <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                    ...
                    <a href="<?php echo URLROOT ?>/admin/addType"><div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div></a>
                         <a href="<?php echo URLROOT ?>/admin/getType"><div class="portfolio-hover-content"><i class="fas fa-eye fa-3x"></i></div></a>
